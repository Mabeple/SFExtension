...
public extension UITableView {
    ...
    public func getReusableCell<T: UITableViewCell>(withClass name: T.Type) -> T {
    ...
    /// - Returns: UITableViewCell object with associated class name.
    public func getReusableCell<T: UITableViewCell>(withClass name: T.Type, for indexPath: IndexPath) -> T {
    ...
    public func getReusableHeaderFooterView<T: UITableViewHeaderFooterView>(withClass name: T.Type) -> T {
