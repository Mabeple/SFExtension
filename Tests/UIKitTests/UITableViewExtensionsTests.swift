...
class UITableViewExtensionsTests: XCTestCase {
    ...
    func testDequeueReusableCellWithClass() {
        ...
        let cell = tableView.getReusableCell(withClass: UITableViewCell.self)
    ...
    func testDequeueReusableCellWithClassForIndexPath() {
        ...
        let cell = tableView.getReusableCell(withClass: UITableViewCell.self, for: indexPath)
        XCTAssertNotNil(cell)
    }
    ...
    func testDequeueReusableHeaderFooterView() {
        ...
        let headerFooterView = tableView.getReusableHeaderFooterView(withClass: UITableViewHeaderFooterView.self)
    ...
    func testRegisterReusableViewWithClassAndNib() {
        ...
        let view = tableView.getReusableHeaderFooterView(withClass: UITableViewHeaderFooterView.self)
    ...
    func testRegisterCellWithClassIndexPath() {
        tableView.register(cellWithClass: UITableViewCell.self)
        let cell = tableView.getReusableCell(withClass: UITableViewCell.self, for: IndexPath(row: 0, section: 0))
        XCTAssertNotNil(cell)
    }
