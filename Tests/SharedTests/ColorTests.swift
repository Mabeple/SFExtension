...
final class ColorExtensionsTests: XCTestCase {
    ...
    func testRgbComponents() {
        ...
        XCTAssertEqual(Color(hex: 0xFFFAFA)?.rgbComponents.red, 0xFF)
    }
    ...
    func testCgFloatComponents() {
        ...
        XCTAssertEqual(Int(Color(hex: 0xFFFAFA)!.cgFloatComponents.red * 255.0), 0xFF)
    }
    ...
    func testUInt() {
        var color = Color(hex: 0xFF0000, transparency: 1)
        XCTAssertEqual(color?.uInt, 0xFF0000)
        
        color = Color(hex: 0x0000FF, transparency: 1)
        XCTAssertEqual(color?.uInt, 0x0000FF)
        
        color = Color(hex: 0x000000, transparency: 1)
        XCTAssertEqual(color?.uInt, 0x000000)
        
        color = Color(hex: 0xFFFFFF, transparency: 1)
